...
CMD=(env HOME=/tmp/godot-visual-home GODOT_USER_DIR=/tmp/godot-visual SCREENSHOT_DIR="$SCREENSHOT_DIR" "$GODOT_BIN" --headless --path project res://tests/visual_e2e.tscn)
